...
export default function Squares() {
  ...
  //useState should be set to null since we initially do not want any squares to be active
  ...
  const getClassName = (id) => {
    ...
    // because this helper function is adding a class to the classlist, we need to add a space before active otherwise we would get "squareactive" vs "square active"
  };
